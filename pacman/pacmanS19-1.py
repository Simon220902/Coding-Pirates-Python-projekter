#Pacman sprites + animation
#Pacman ligner ikke rigtig sig selv vel, nej lad os bruge den klassiske pacman.
#Vi skal tænke over hvordan vi skal bruge billedet
#Step 1, få en statisk version af en pacman
#Vi laver en variabel med pacmans billede og laver om på tegn funktionen
...
class Pacman:
	...
	def tegn(self):
		...
		skærm.blit(self.billede, (self.x, self.y), (0, 0, self.billedBredde, self.billedHøjde))
