#Spis spøgelserne
#Få powerosten ind i banen (3)
#Tegn den (lav om på tegnbane og lav ny tegnPowerBlokPoint funktion)
#Få pacman til at kunne spise den
	#Hvorefter følger at vi skal bruge forskellige modes.
