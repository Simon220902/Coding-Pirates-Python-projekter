#Pacman animation
#Vi gør sådan at pacman vender den rigtige vej.
#Det gør vi ved at se på hans retning og så bestemme hvilken række vi skal tegne fra.
#0:Venstre, 1:Højre, 2:Op, 3:Ned
#vi laver en variabel der hedder billedRække i pacman.
