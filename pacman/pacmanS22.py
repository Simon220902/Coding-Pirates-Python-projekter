#Lyde
#Jeg vil opfordrer jer til at lave jeres egne lyde, men her viser jeg hvordan man får spiselyden ind.
#vi starter med at få lyd modulet ind. Vi laver derefter variablen spislyd i pacman
#Hvis der bliver spist osten så afspiller vi lyden
#så sørger vi lige for at den ikke spilles oveni hinanden
...
pygame.mixer.init() #Vi starter lyd modulet
...
class Pacman:
	...
	def flyt(self):
		...
		if bane[self.række][self.blok] == 2:
			...
			self.point += 10
			#Hvis lyden ikke allerede afspilles
