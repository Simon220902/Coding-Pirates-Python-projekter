#Spøgelse
#Lav spøgelse klasse som basalt set er den samme som pacman, men dog med farve fordi vi vil have forskellige
	#Tegn funktion
#Få målet som argument og sæt det ind i klassens
#Generér de mulige positioner
#Find distancen fra de mulige positioner til målet (lav dist fuktion)
#Vælg den mindste
#Opdater hastigheden
#Flyt spøgelset
#Lav et spøgelse (blinky) og få den ind i opdater og tegn funktionen plus farven
...
class Spøgelse:
	def __init__(self, række, blok, farve):
		...
		self.xf = 1
		self.yf = 0
		#Variabler til at tegne spøgelset
		self.x = self.blok*blokBredde
		self.y = self.række*blokHøjde
		self.r = blokHøjde//2
		self.farve = farve
	...
	def flyt(self, målRække, målBlok):
		...
		for ret in [(0,-1), (-1,0), (0,1), (1,0)]:
			...
			#Sørger for at spøgelset ikke går ud fra banen		
