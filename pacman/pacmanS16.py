#Skift mellem modesne
#Lav variabel der holder styr på tiden (dt)
#Lav funktion skiftMode, der skifter mellem de forskellige modes
#Ændre måden vi skifter mode i pacman (altså mode 3) så vi starter tiden forfra
#Eleverne kan selv lave deres egne tidstabeller osv.
