#Pacman animation
#Vi animere ham så han skifter mellem de to billeder i rækken
#Vi skifter mellem de to billeder
#Vi forskyder der hvor vi tegner billedet fra
...
class Pacman:
	...
	def tegn(self):
		...
		#Vi tegner pacman, hvor vi forskyder x-koordinatet afhængigt af hvilket billede vi er på.
		skærm.blit(self.billede, (self.x, self.y), (self.billedBredde*self.animer, 0, self.billedBredde, self.billedHøjde))
